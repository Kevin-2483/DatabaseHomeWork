...
const DeleteAdmin = ({ AdminID, dataServer, form4 }) => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      const response = await fetch(dataServer + "/deleteID", {
        method: "POST",
        headers: {
      ...
      if (!jsonData.success) {
        ...
        message.success("删除成功,正返回重新登陆", 3, navigateTo);
      }
    } catch (error) {
...
DeleteAdmin.propTypes = {
  ...
  form4: PropTypes.func.isRequired,
};
